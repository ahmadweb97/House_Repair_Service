                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" wire:submit.prevent='updateService'>
                                    ...
                                    <div class="form-group">
                                        <label for="service_category_id" class="control-label col-sm-3">
                                             Service Category:
                                        </label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="featured" class="control-label col-sm-3">
                                           Featured:
                                        </label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control"  cols="10" rows="5" wire:model='description'></textarea>
                                            @error('description')
                                            <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control"  cols="10" rows="5" wire:model='inclusion'></textarea>
                                            @error('inclusion')
                                            <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="exclusion" class="control-label col-sm-3">
                                             Exclusion:
                                        </label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control"  cols="10" rows="5" wire:model='exclusion'></textarea>
                                            @error('exclusion')
                                            <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
