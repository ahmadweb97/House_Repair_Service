                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <aside>
                                <h2>The Office</h2>
                                <address>
                                    <strong>House Repair Services.</strong><br>
                                    <i class="fa fa-map-marker"></i><strong>Address: </strong>Beirut,Downtown
                                    Lebanon<br>
                                    <i class="fa fa-phone"></i><strong>Phone: </strong> +961-123456
                                </address>
                                <address>
                                    <strong>House Repair Services Email</strong><br>
                                    <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                        href="mailto:ashehade9.as@gmail.com"> info@houserepairservice.com.lb</a><br>
                        ...
                        <div class="col-md-8">
                            ...
                            <form id="contactform" class="form-theme"
                                method="post" wire:submit.prevent='sendMessage'>
