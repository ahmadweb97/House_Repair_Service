...
class AdminEditServiceComponent extends Component
{
    ...
    public function updated($fields)
    {
        ...
        if ($this->newthumbnail) {
            ...
            $this->validateOnly($fields,[
            'newthumbnail'=> 'required|mimes:jpg,jpeg,png',
    ...
    public function updateService()
    {
        ...
        if ($this->newthumbnail) {
            ...
            unlink('images/services/thumbnails'.'/'.$service->thumbnail); // remove old image
        ...
        if ($this->newimage) {
         ...
         unlink('images/services'.'/'.$service->image); // remove old image
        ...
        return redirect('/admin/all-services')->with('message','Service has been updated successfully!');
